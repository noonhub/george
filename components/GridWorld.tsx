...
const tileTypesToEdit: { name: string; type: TileEnum; distractionType?: DistractionKey; emoji?: string }[] = [
  ...
  { name: 'TV', type: TileEnum.TV, distractionType: 'TV', emoji: DISTRACTION_EMOJIS.TV },
  { name: 'Friends', type: TileEnum.FRIENDS, distractionType: 'FRIENDS', emoji: DISTRACTION_EMOJIS.FRIENDS },
  { name: 'Playground', type: TileEnum.PLAYGROUND, distractionType: 'PLAYGROUND', emoji: DISTRACTION_EMOJIS.PLAYGROUND },
